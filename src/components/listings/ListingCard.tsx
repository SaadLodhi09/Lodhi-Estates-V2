      ...
      <Link to={`/listings/${property.id}`} className="block">
        <div className="relative aspect-[4/5] w-full overflow-hidden bg-mist">
          ...
          <div className="absolute right-4 top-4 flex items-center gap-2">
            ...
            <span
              className={cn(
                'flex h-8 items-center bg-ink/60 px-2 font-mono text-[10px] uppercase tracking-widest2 backdrop-blur-sm',
        ...
        <div className="mt-5 flex items-start justify-between gap-4">
          <div>
            <h3 className="font-display text-xl text-ink transition-colors group-hover:text-moss">
              {property.name}
            </h3>
